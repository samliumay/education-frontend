<template>
  <main class="px-10 py-6">
    ...
    <p class="text-brand-gray mb-10">
      ...
      Online-Terminbuchung nutzen oder im ClavisOnlineshop Kurse kaufen, werden
      personenbezogene Daten aufgenommen. In den folgenden Abschnitten erläutern
      wir im Detail, welche Daten aufgenommen und verarbeitet werden, welche
      rechtlichen Grundlagen hierfür vorliegen und wie Sie die Löschung der
      Daten veranlassen können. Als Privatschule sind wir zur Sammlung und
      Datenweitergabe an Dritte verpflichtet. Diese sind insbesondere deutsche
      und EU-Behörden, sowie aus steuerlichen Gründen unser Steuerberater und
      unsere Dozenten, die Zugriff auf die Daten unserer Schüler*Innen haben.
      Unsere Website nutzt desweitern zur Reichweitenmessung, Werbung und
      Seitengestaltung die Google-Webdienste Google Analytics, Google AdWords,
      Google Fonts und Google Maps. In den betreffenden Abschnitten unten wird
      erläutert, welche Daten dort gesammelt werden, bzw. wie Sie dies vermeiden
      können.
    </p>
    ...
    <p class="text-brand-gray mb-10">
      ...
      Einwilligung weiter. Die Verarbeitung der in die Formulare eingegebenen
      Daten erfolgt ausschließlich auf Grundlage Ihrer Einwilligung (Art. 6 Abs.
      1 lit. a DSGVO). Sie können diese Einwilligung jederzeit widerrufen. Dazu
      ...
      unberührt. Die von Ihnen in Formularen eingegebenen Daten verbleiben bei
    ...
    <p class="text-brand-gray">
      ...
      und Ihrem Passwort in unserem Shop einloggen können, ohne Ihre
      Kontaktdaten erneut eingeben zu müssen. Ihre personenbezogenen Daten
    ...
    <p class="text-brand-gray mb-10">
      ...
      lit. b DSGVO zu den genannten Zwecken für die angemessene Bearbeitung
      Ihrer Bestellung und für die beidseitige Erfüllung von Verpflichtungen aus
      dem Kaufvertrag erforderlich. Die für die Abwicklung Ihrer Bestellung von
      uns erhobenen personenbezogenen Daten werden bis zum Ablauf der
      gesetzlichen Aufbewahrungspflicht gespeichert und danach gelöscht, es sei
      denn, dass wir nach Artikel 6 Abs. 1 S. 1 lit. c DSGVO aufgrund von
      ...
      oder Sie in eine darüber hinausgehende Speicherung nach Art. 6 Abs. 1 S. 1
    ...
    <p class="text-brand-gray mb-10">
      ...
      nicht aus. Bei der Zahlung mit PayPal werden die von Ihnen bei PayPal
    ...
    <p class="text-brand-gray mb-10">
      ...
      E-Mail-Adresse Kundennummer Bestellnummer Bankverbindung Kreditkartendaten
      Gültigkeitsdauer der Kreditkarte Prüfnummer der Kreditkarte (CVC) Datum
      und Uhrzeit der Transaktion Transaktionssumme Name des Anbieters Ort Die
      ...
      Zahlungsmethode zu wählen.] Stripe nimmt bei Datenverarbeitungstätigkeiten
      eine Doppelrolle als Verantwortlicher und Auftragsverarbeiter ein. Als
      Verantwortlicher verwendet Stripe Ihre übermittelten Daten zur Erfüllung
      ...
      diesen Prozess keinen Einfluss. Als Auftragsverarbeiter fungiert Stripe,
      um Transaktionen innerhalb der Zahlungsnetzwerke abschließen zu können. Im
      Rahmen des Auftragsverarbeitungsverhältnisses wird Stripe ausschließlich
      nach unserer Weisung tätig und wurde im Sinne des Art. 28 DSGVO
      vertraglich verpflichtet, die datenschutzrechtlichen Bestimmungen
      einzuhalten. Stripe hat Compliance-Maßnahmen für internationale
      ...
      EUStandardvertragsklauseln (SCCs). Weitere Informationen zu Widerspruchs-
      und Beseitigungsmöglichkeiten gegenüber Stripe finden Sie unter:
      https://stripe.com/privacy-center/legal Ihre Daten werden von uns bis zum
      Abschluss der Zahlungsabwicklung gespeichert. Dazu zählt auch der Zeitraum
      der für die Bearbeitung von Rückerstattungen, Forderungsmanagement und
    ...
    <p class="text-brand-gray">
      ...
      Informationspunkten auf Basis von Nutzeraktivitäten temporär im Browser
      des Benutzers abgelegt. Besuchs-Präferenzen und Webseiten-Einstellungen
      können somit definiert und gespeichert werden. Jeder Browser unterscheidet
      sich in der Art, wie er die Cookie-Einstellungen verwaltet. Diese ist in
      dem Hilfemenü jedes Browsers beschrieben, welches Ihnen erläutert, wie Sie
    ...
    <p class="text-brand-gray mb-10">
      ...
      es möglich, Daten, Sitzungen und Interaktionen über mehrere Geräte hinweg
      einer pseudonymen User-ID zuzuordnen und so die Aktivitäten eines Nutzers
      geräteübergreifend zu analysieren. Google Analytics verwendet sog.
      ...
      das Cookie erzeugten Informationen über Ihre Benutzung dieser Website
      ...
      USA übertragen und dort gekürzt. Wir weisen Sie darauf hin, dass auf
      ...
      zu gewährleisten. Die im Rahmen von Google Analytics von Ihrem Browser
    ...
    <p class="text-brand-gray mb-10">
      ...
      Browser-Addon herunterladen und installieren. Opt-Out-Cookies verhindern
    ...
    <p class="text-brand-gray mb-10">
      ...
      auch im Google-Werbenetzwerk zu schalten. Google AdWords ermöglicht es
      einem Werbetreibenden, vorab bestimmte Schlüsselwörter festzulegen,
      ...
      Fremdwerbung auf unserer Internetseite. Gelangt eine betroffene Person
      über eine Google-Anzeige auf unsere Internetseite, wird auf dem
      informationstechnologischen System der betroffenen Person durch Google ein
      sogenannter Conversion-Cookie abgelegt. Was Cookies sind, wurde oben
      bereits erläutert. Ein Conversion-Cookie verliert nach dreißig Tagen seine
      Gültigkeit und dient nicht zur Identifikation der betroffenen Person. Über
      den Conversion-Cookie wird, sofern das Cookie noch nicht abgelaufen ist,
      nachvollzogen, ob bestimmte Unterseiten, beispielsweise der Warenkorb von
      einem Online-Shop-System, auf unserer Internetseite aufgerufen wurden.
      ...
      Warenkauf vollzogen oder abgebrochen hat. Die durch die Nutzung des
      Conversion-Cookies erhobenen Daten und Informationen werden von Google
      verwendet, um Besuchsstatistiken für unsere Internetseite zu erstellen.
      Diese Besuchsstatistiken werden durch uns wiederum genutzt, um die
      ...
      AdWords-Anzeige zu ermitteln und um unsere AdWordsAnzeigen für die Zukunft
      ...
      Conversion-Cookies werden personenbezogene Informationen, beispielsweise
      die durch die betroffene Person besuchten Internetseiten, gespeichert. Bei
      jedem Besuch unserer Internetseiten werden demnach personenbezogene Daten,
      einschließlich der IPAdresse des von der betroffenen Person genutzten
      ...
      Google einen Conversion-Cookie auf dem informationstechnologischen System
      der betroffenen Person setzt. Zudem kann ein von Google AdWords bereits
    ...
    <p class="text-brand-gray mb-10">
      ...
      Zweck muss der von Ihnen verwendete Browser Verbindung zu den Servern von
      Google aufnehmen. Hierdurch erlangt Google Kenntnis darüber, dass über
      Ihre IP-Adresse unsere Website aufgerufen wurde. Die Nutzung von Google
    ...
    <p class="text-brand-gray mb-10">
      ...
      die sich aus Ihrer besonderen Situation ergeben oder sich der Widerspruch
    ...
    <p class="text-brand-gray mb-10">
      ...
      geschlossenen Darstellung des Schüssel- beziehungsweise Schloss- Symbols
      in der unteren Statusleiste Ihres Browsers. Wir bedienen uns im Übrigen
    ...
    <p class="text-brand-gray mb-10">
      ...
      haben wir auf verschiedene Webangebote zugegriffen und diese auf unsere
      spezifischen Bedürfnisse zugeschnitten. Im Folgenden nennen wir die
      Quellen und die diesbezüglichen Abschnitte in unserer
      ...
      Datenschutzerklärung: Muster-Datenschutzerklärung von RA Andreas Gerstel,
      anwaltblog24.de; Stripe: Muster-Datenschutzerklärung von opr.vc; Cookies:
      Cookie- Hinweis von eigene-homepage.net; Google Analytics:
      Datenschutzhinweis von intersoftconsulting.de; Google Adwords:
