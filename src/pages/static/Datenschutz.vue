<template>
  <div>
    ...
    <p>Die Clavis Kunst und Wissenschaft Privatschule GmbH i.G. ist eine Nachmittagsschule inprivater Trägerschaft. Weitere Informationen über die Arbeit unserer Schule finden Sie im Bereich Über uns. Ausführliche Informationen zum rechtlichen Status unserer Schule finden Sie im Impressum und alle Kontaktmöglichkeiten auf unserer Kontakt-Seite.</p>

    <n-h3>Ihre Rechte</n-h3>
    <p>Neben der detaillierten Darstellung, welche personenbezogenen Daten wir sammeln, wie und warum wir sie sammeln, enthält unsere Datenschutzerklärung im Abschnitt „Ihre Datenschutzrechte“ unten auf dieser Seite eine umfassende Darstellung ihrer gesetzlich festgeschriebenen Rechte beim Datenschutz.</p>

    <n-h3>Welche personenbezogenen Daten wir sammeln und warum wir sie sammeln</n-h3>
    <p>Auf unserer Website erheben wir an verschiedenen Stellen personenbezogene Daten. Zum Beispiel, wenn Sie ein Kontakt-, Anmelde-, Feedback- oder Newsletter-Formular ausfüllen, wenn Sie für die Buchung von Kursen unsere Online-Terminbuchung nutzen oder im ClavisOnlineshop Kurse kaufen, werden personenbezogene Daten aufgenommen. In den folgenden Abschnitten erläutern wir im Detail, welche Daten aufgenommen und verarbeitet werden, welche rechtlichen Grundlagen hierfür vorliegen und wie Sie die Löschung der Daten veranlassen können. Als Privatschule sind wir zur Sammlung und Datenweitergabe an Dritte verpflichtet. Diese sind insbesondere deutsche und EU-Behörden, sowie aus steuerlichen Gründen unser Steuerberater und unsere Dozenten, die Zugriff auf die Daten unserer Schüler*Innen haben. Unsere Website nutzt desweitern zur Reichweitenmessung, Werbung und Seitengestaltung die Google-Webdienste Google Analytics, Google AdWords, Google Fonts und Google Maps. In den betreffenden Abschnitten unten wird erläutert, welche Daten dort gesammelt werden, bzw. wie Sie dies vermeiden können.</p>

    <n-h3>Kontakt-, Anmelde-, Feedback- und Newsletterformulare</n-h3>
    <p>Wenn Sie uns per Kontaktformular, Anmelde-, Feedback- oder Newsletterformular personenbezogene Daten zukommen lassen, werden Ihre Angaben aus den Formularen inklusive der von Ihnen dort angegebenen Kontaktdaten zwecks Bearbeitung der Anfrage und für den Fall von Anschlussfragen bei uns gespeichert. Diese Daten geben wir nicht ohne Ihre Einwilligung weiter. Die Verarbeitung der in die Formulare eingegebenen Daten erfolgt ausschließlich auf Grundlage Ihrer Einwilligung (Art. 6 Abs. 1 lit. a DSGVO). Sie können diese Einwilligung jederzeit widerrufen. Dazu reicht eine formlose Mitteilung per E-Mail an uns. Die Rechtmäßigkeit der bis zum Widerruf erfolgten Datenverarbeitungsvorgänge bleibt vom Widerruf unberührt. Die von Ihnen in Formularen eingegebenen Daten verbleiben bei uns, bis Sie uns zur Löschung auffordern, Ihre Einwilligung zur Speicherung widerrufen oder der Zweck für die Datenspeicherung entfällt (z.B. nach abgeschlossener Bearbeitung Ihrer Anfrage). Zwingende gesetzliche Bestimmungen – insbesondere Aufbewahrungsfristen – bleiben unberührt.</p>

    <n-h3>Der Clavis-Onlineshop</n-h3>
    <p>Sie können im Onlineshop unserer Webseite Bestellungen in unserem Shop als registrierter Kunde tätigen. Eine Registrierung hat den Vorteil, dass Sie sich im Falle einer künftigen Bestellung direkt mit Ihrer E-Mail-Adresse und Ihrem Passwort in unserem Shop einloggen können, ohne Ihre Kontaktdaten erneut eingeben zu müssen. Ihre personenbezogenen Daten werden dabei in eine Eingabemaske eingegeben und an uns übermittelt und gespeichert. Wenn Sie über unsere Webseite eine Bestellung tätigen, so erheben wir im Shop zunächst folgende Daten:</p>
    <ul>
    ...
    <ul>
      ...
      <li>zur Abwicklung von evtl. vorliegenden Haftungsansprüchen, sowie der Geltendmachung etwaiger Ansprüche gegen Sie;</li>
    ...
    <ul>
      <li>Internet Explorer: https://support.microsoft.com/de-de/help/17442/windowsinternet-explorer-delete-manage-cookies</li>
    ...
    <p>Die Rechtsgrundlage für den Einsatz von Google Analytics ist ihre Einwilligung gemäß Art. 6 Abs. 1 S.1 lit. a DSGVO. Empfänger / Kategorien von Empfängern Der Empfänger der erhobenen Daten ist Google.</p>

    <n-h3>Übermittlung in Drittstaaten</n-h3>
    <p>Die personenbezogenen Daten werden unter dem EU-US Privacy Shield auf Grundlage des Angemessenheitsbeschlusses der Europäischen Kommission in die USA übermittelt. Das Zertifikat können Sie hier abrufen.</p>
    ...
    <p>Auf unserer Kontakt-Seite haben wir ein Landkarte des Dienstes “Google Maps” des Anbieters Google LLC, 1600 Amphitheatre Parkway, Mountain View, CA 94043, USA, eingebunden. Hier können zu den verarbeiteten Daten IP-Adressen und Standortdaten der Nutzer gehören, die jedoch nicht ohne deren Einwilligung, im Regelfall bei durch Einstellungen bei ihren Mobilgeräte, erhoben werden. Die Daten können in den USA verarbeitet werden. Weitere Informationen finden Sie in der Datenschutzerklärung von Google https://www.google.com/policies/privacy/.</p>
...
gemäß Art. 15 DSGVO Auskunft über Ihre von uns verarbeiteten personenbezogenen Daten zu verlangen. Insbesondere können Sie Auskunft über die Verarbeitungszwecke, die Kategorie der personenbezogenen Daten, die Kategorien von Empfängern, gegenüber denen Ihre Daten offengelegt wurden oder werden, die geplante Speicherdauer, das Bestehen eines Rechts auf Berichtigung, Löschung, Einschränkung der Verarbeitung oder Widerspruch, das Bestehen eines Beschwerderechts, die Herkunft Ihrer Daten, sofern diese nicht bei mir erhoben wurden, sowie über das Bestehen einer automatisierten Entscheidungsfindung einschließlich Profiling und ggf. aussagekräftigen Informationen zu deren Einzelheiten verlangen;•    gemäß    Art. 16    DSGVO    unverzüglich    die    Berichtigung    unrichtiger    oder Vervollständigung Ihrer bei uns gespeicherten personenbezogenen Daten zu verlangen;
      </li><li>gemäß Art. 17 DSGVO die Löschung Ihrer bei uns gespeicherten personenbezogenen Daten zu verlangen, soweit nicht die Verarbeitung zur Ausübung des Rechts auf freie Meinungsäußerung und Information, zur Erfüllung einer rechtlichen Verpflichtung, aus Gründen des öffentlichen Interesses oder zur Geltendmachung, Ausübung oder Verteidigung von Rechtsansprüchen erforderlich ist;</li>
    ...
    <p>Diese Datenschutzerklärung ist aktuell gültig und hat den Stand Mai 2018. Durch die Weiterentwicklung unserer Website und Angebote darüber oder aufgrund geänderter gesetzlicher beziehungsweise behördlicher Vorgaben kann es notwendig werden, diese Datenschutzerklärung zu ändern.</p>

    <n-h3>Quellen dieser Datenschutzerklärung</n-h3>
    <p>Um diese Datenschutzerklärung maßgeschneidert auf die Gegebenheiten unseres Webauftrittes im Zusammenhang mit unserem Unternehmen, der Clavis Kunst und Wissenschaft Privatschule GmbH i.G., formulieren zu können, haben wir auf verschiedene Webangebote zugegriffen und diese auf unsere spezifischen Bedürfnisse zugeschnitten. Im Folgenden nennen wir die Quellen und die diesbezüglichen Abschnitte in unserer Datenschutzerklärung: Der Clavis-Onlineshop, Ihre Datenschutzrechte, Wiederspruchsrecht, Datensicherheit und Aktualität dieser Datenschutzerklärung: Muster-Datenschutzerklärung von RA Andreas Gerstel, anwaltblog24.de; Stripe: Muster-Datenschutzerklärung von opr.vc; Cookies: Cookie- Hinweis von eigene-homepage.net; Google Analytics: Datenschutzhinweis von intersoftconsulting.de; Google Adwords: Datenschutzerklärungs-Generator der Deutschen Gesellschaft für Datenschutz GmbH (DGD) in Kooperation mit dem Datenschutzanwalt Christian Solmecke.</p>
  </div>
</template>
