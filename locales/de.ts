export const de = {
  ...
  buy: {
    enterData: 'Geben Sie die Details ein',
    chooseDays: 'Wählen Sie Besuchstage aus',
    threeDays: 'Maximal bis zu 3 Tage',
    firstLesson: 'Wählen Sie das Datum Ihres ersten Besuchs',
    now: 'Sofort',
    later: 'Später',
